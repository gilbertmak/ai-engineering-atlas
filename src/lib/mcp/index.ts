...
export default defineMcp({
  ...
  version: "0.1.0",
  instructions:
    "Tools for the AI Engineering Insights catalog of verified conference talks. Use `search_talks` to find talks by topic, theme, tag, or year, `get_talk_summary` for the full editorial summary of one talk, and `list_tracks` to browse the nine engineering themes.",
